...
import (
	"crypto/rand"
	"encoding/base32"
	"github.com/wsrf16/swiss/sugar/crypto/otp"
	"github.com/wsrf16/swiss/sugar/crypto/otp/hotp"
	"github.com/wsrf16/swiss/sugar/crypto/otp/internal"
	"io"
	"math"
	"net/url"
	"strconv"
...
func GenerateCodeNow(secret string) (string, error) {
	return GenerateCode(secret, time.Now())
}
