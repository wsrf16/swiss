...
// Delete removes rulespec in specified table/chain
func (ipt *IPTables) DeleteByLineNumber(table, chain string, line int) error {
	cmd := append([]string{"-t", table, "-D", chain}, strconv.Itoa(line))
	return ipt.run(cmd...)
}
...
func (ipt *IPTables) Stats(table, chain string) ([][]string, error) {
	args := []string{"-t", table, "-L", chain, "-n", "-v", "-x", "--line"}
